...
export const EditInvoiceSchema = z.object({
    id: z.number(),
    bill_from: z.string().min(2, "at least 2 words required").optional(),
    number: z.string().min(3, "at least 3 numbers required").optional(),
    due_date: z.string().optional().nullable().transform((value) => (value === "default" ? undefined : value)),
    payment_date: z.string().optional().nullable(),
    ...
    shipping_cost: z.number().optional().nullable(),
    paid_amount: z.number().optional().nullable(),
    products: z.array(EditProductSchema).optional(),
    note: z.string().optional().nullable(),
    terms: z.string().optional().nullable(),
    bank: z.string().optional().nullable(),
    amount: z.number().optional(),
