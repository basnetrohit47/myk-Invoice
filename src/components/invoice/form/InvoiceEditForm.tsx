...
import { EditInvoiceByIdParam, EditInvoiceSchema } from "@/repository/params/invoice.param";
import { useEffect, useRef } from "react";
import ClassicInvoicePreview from "../preview/ClassicInvoicePreview";
import { useGetInvoiceById } from "@/repository/hooks/useGetInvoiceById.hook";
import { useEditInvoiceById } from "@/repository/hooks/useEditInvoiceById.hook";
        ...
        <form className="w-full " onSubmit={handleSubmit(onSubmit)}>
          <div className="flex gap-8 ">
            ...
            <div className="w-[35%] ">
              ...
              <ClassicInvoicePreview formData={formData} ref={printRef} total={45} subTotal={5} />
            </div>
          </div>
        </form>
      </Box>
